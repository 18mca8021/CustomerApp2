...
const Screen10 = ({navigation}) => {
    ...
    return (
        ...
        <View style={{backgroundColor:'#ffffff'}}>
          ...
          <Image style={{alignSelf:'flex-end', margin: 10,height:30,width:30,bottom:125,right:40}} source={require('../images/blankradiobutton.png')}/>
          ...
          <Image style={{alignSelf:'flex-end', margin: 10,height:30,width:30,bottom:220,right:40}} source={require('../images/darkradiobutton.png')}/>
